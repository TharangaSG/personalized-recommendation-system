...
class HopsworksRankingModel:
    ...
    def deploy(cls, project):
        ...
        # )
        transformer_script_path = "https://c.app.hopsworks.ai/Projects/Rec_sys/Resources/ranking_transformer.py"
        ...
        #     uploaded_file_path,
        # )
        predictor_script_path = "https://c.app.hopsworks.ai/Projects/Rec_sys/Resources/ranking_predictor.py"
