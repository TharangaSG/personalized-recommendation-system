...
class TwoTowerModel(tf.keras.Model):
    ...
    def train_step(self, batch) -> tf.Tensor:
        ...
        # Use tf.cond for conditional operations instead of Python if-statements
        # Mask out gradients with NaN values
        gradients = [
...
class TwoTowerDataset:
    ...
    def query_features(self) -> list[str]:
        ...
        return ["customer_id", "month_sin", "month_cos"]
...
class TwoTowerTrainer:
    ...
    # In your TwoTowerTrainer class
    def train(self, train_ds, val_ds):
        self._initialize_query_model(train_ds)
        
        # Use a lower initial learning rate
        initial_lr = settings.TWO_TOWER_LEARNING_RATE * 0.1
        ...
        # Use the scheduler with the optimizer
        ...
        # Add early stopping to prevent overfitting and detect NaN problems
